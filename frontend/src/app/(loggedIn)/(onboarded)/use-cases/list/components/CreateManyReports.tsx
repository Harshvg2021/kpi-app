...
const UploaduseCases = () => {
  ...
  // const createuseCases = useCreateManyUseCases({
    ...
    >
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter className="flex gap-2">
          ...
          <Button
            // disabled={createuseCases.isPending || files?.length === 0}
            // loading={createuseCases.isPending}
            onClick={async () => {
              // await createuseCases.mutateAsync({
              //   mutationBody: {
              //     useCasesList: useCases.map((e) => {
              //       return {
              //         useCases_description: e.description,
              //         useCases_name: e.title,
              //       };
              //     }),
              //   },
              // });
              ...
              setDialogOpen(false);
              toast.success("UseCases created successfully");
            }}
            className="bg-blue-500 hover:bg-blue-600"
            type="submit"
          >
